...
export const metadata = {
  title: 'SecOra - Affiliate Marketing Platform',
  description: 'Professional affiliate marketing platform with comprehensive tracking, commission management, and payout automation.',
};
